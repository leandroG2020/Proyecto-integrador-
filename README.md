Proyecto Integrador – Plataforma de Transporte Universitario
...
•	El transporte público suele ser lento o congestionado
...
•	Publicar rutas o viajes disponibles
•	Buscar viajes realizados por otros estudiantes
...
•	Aplicación móvil
•	Sistema de calificación de conductores y pasajeros
...
El sistema se basa en una arquitectura Cliente – Servidor, donde los usuarios acceden desde una aplicación web que se conecta a un servidor central que gestiona la información del sistema.
La descripción completa de la arquitectura se encuentra en el archivo ARQUITECTURA.md.
